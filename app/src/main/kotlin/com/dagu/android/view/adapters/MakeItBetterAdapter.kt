...
class MakeItBetterAdapter(private val context: Context, private val list: List<MakeItBetterItem>) :
    RecyclerView.Adapter<MakeItBetterAdapter.MakeItBetterHolderView>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MakeItBetterHolderView {
        val itemBinding =
            MakeItBetterItemBinding.inflate(LayoutInflater.from(context), parent, false)
        return MakeItBetterHolderView(itemBinding)
    }

    override fun onBindViewHolder(holder: MakeItBetterHolderView, position: Int) {
    ...
    class MakeItBetterHolderView(private val itemBinding: MakeItBetterItemBinding) :
